      ...
      <div className="flex flex-col md:flex-row items-center gap-28">
        ...
        <div className="space-y-[38px]">
          <h2 className="text-3xl font-medium">
            What do we offer you as an <span className="text-primary">SEO Agency?</span>
          </h2>
          <p>
          ...
          <button className="btn secondary-btn hover:text-black">Explore Now</button>
        </div>
        {/* icon container */}
        <div className="flex flex-col md:flex-row md:gap-5">
          ...
          <div>
            ...
            <div className="border border-[#E71D36] rounded-3xl p-5 space-y-3 mb-8 md:w-[270px]">
            <div className="w-[100px] h-[100px] bg-[#FFECEA] flex items-center justify-center rounded-xl">
             <BiPen className="text-primary text-5xl"/>
            </div>
            <h4 className="text-2xl font-medium">Global SEO</h4>
          ...
          <div className="md:mt-[100px]">
            ...
            <div className="border border-[#E71D36] rounded-3xl p-5 space-y-3 md:w-[270px]">
            <div className="w-[100px] h-[100px] bg-[#FFECEA] flex items-center justify-center rounded-xl">
             <BiPen className="text-primary text-5xl"/>
            </div>
            <h4 className="text-2xl font-medium">Global SEO</h4>
